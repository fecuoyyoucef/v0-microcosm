...
export function ChatContainer({
  ...
  return (
    <div className="relative flex flex-col h-full w-full max-w-full box-border overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full w-full max-w-full box-border overflow-hidden bg-transparent">
        <ChatHeader
          group={group}
          members={members}
