...
/**
 * Synaptic Space Logo - Uses the brand neuron icon at /public/icons/app-logo.jpg
 */
  ...
  if (variant === "wordmark") {
    return (
      <div className={cn("flex items-center gap-2.5", className)}>
        ...
        <span className="text-xl font-semibold tracking-tight">Synaptic</span>
      </div>
    )
  }
...
function LogoMark({
  ...
  return (
    <Image
      ...
      priority
      className={cn(
        "shrink-0 select-none rounded-2xl object-cover",
