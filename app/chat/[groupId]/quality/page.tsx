...
const translations = {
  ...
  fr: {
    ...
    description: "Nous développons un système intelligent pour évaluer la qualité des conversations.",
...
export default function QualityComingSoonPage({ params }: { params: Promise<{ groupId: string }> }) {
