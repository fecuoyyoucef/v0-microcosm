...
const translations = {
  ar: {
    ...
    description: "نعمل على تطوير نظام بحث قوي يتيح لك العثور على الرسائل والملفات بسهولة.",
    features: "الميزات القادمة:",
    feature1: "بحث سريع في جميع الرسائل",
    feature2: "تصفية متقدمة حسب التاريخ والمرسل",
    feature3: "بحث ذكي باستخدام الذكاء الاصطناعي",
    feature4: "البحث في الملفات والمرفقات",
  ...
  en: {
    ...
    description: "We're building a powerful search system to find messages and files with ease.",
    features: "Upcoming Features:",
    feature1: "Quick search across all messages",
    feature2: "Advanced filters by date and sender",
    feature3: "AI-powered smart search",
    feature4: "Search in files and attachments",
  ...
  fr: {
    ...
    description: "Nous développons un système de recherche puissant pour trouver messages et fichiers.",
    features: "Fonctionnalités à venir:",
    feature1: "Recherche rapide dans tous les messages",
    feature2: "Filtres avancés par date et expéditeur",
    feature3: "Recherche intelligente avec IA",
    feature4: "Recherche dans les fichiers et pièces jointes",
    notifyMe: "Me notifier au lancement",
    backToChat: "Retour au chat",
  },
}

export default function SearchComingSoonPage({ params }: { params: Promise<{ groupId: string }> }) {
